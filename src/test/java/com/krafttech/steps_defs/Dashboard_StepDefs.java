...
public class Dashboard_StepDefs {
    ...
    public void enter_credentials_and_validate_that_user_is_on_the_home_page(Map<String, String> map) {
        ...
        String actual = loginPage.getAccountName("name");
        Assert.assertEquals(expected,actual);
    }

    //@And("Go to {string} and {string}")
   // public void goToAnd(String arg0, String arg1) {

    //}

     /*@Then("Verify that {string} and {string} and {string}")
    public void verifyThatAndAnd(String arg0, String arg1, String arg2) {
        DashboardPage dashboardPage = new DashboardPage();
